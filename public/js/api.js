...
(function (global) {
  ...
  global.API = {
    ...
    chickenStart:   (b)    => request('POST', '/api/play/chicken/start', b),
    chickenStep:    (b)    => request('POST', '/api/play/chicken/step', b),
    chickenCashout: (b)    => request('POST', '/api/play/chicken/cashout', b),
    crapsStart:     (b)    => request('POST', '/api/play/craps/start', b),
    crapsRoll:      (b)    => request('POST', '/api/play/craps/roll', b),
    tcpStart:       (b)    => request('POST', '/api/play/tcp/start', b),
    tcpAct:         (b)    => request('POST', '/api/play/tcp/act', b),
    bingo:          (b)    => request('POST', '/api/play/bingo', b),
    derby:          (b)    => request('POST', '/api/play/derby', b),
    cashhunt:       (b)    => request('POST', '/api/play/cashhunt', b),
    bigcatch:       (b)    => request('POST', '/api/play/bigcatch', b),
    rps:            (b)    => request('POST', '/api/play/rps', b),
    neonfruits:     (b)    => request('POST', '/api/play/neonfruits', b),
    megawheel:      (b)    => request('POST', '/api/play/megawheel', b),
    tenpin:         (b)    => request('POST', '/api/play/tenpin', b),
    bullseye:       (b)    => request('POST', '/api/play/bullseye', b),
    firecracker:    (b)    => request('POST', '/api/play/firecracker', b),
    sugarblast:     (b)    => request('POST', '/api/play/sugarblast', b),
    zeusgates:      (b)    => request('POST', '/api/play/zeusgates', b),
    slingo:         (b)    => request('POST', '/api/play/slingo', b),
    miniroulette:   (b)    => request('POST', '/api/play/miniroulette', b),
