...
(function (global) {
  ...
  const GAMES = [
    ...
    { key: 'cosmic',      name: 'Cosmic Reels',   icon: '🌌', cat: 'slots',     tag: 'to 115×' },
    { key: 'crypt',       name: 'Crypt Reels',    icon: '💀', cat: 'slots',     tag: 'to 71×' },
    { key: 'pirate',      name: "Pirate's Hoard", icon: '💰', cat: 'slots',     tag: 'frequent pairs' },
    { key: 'dragon',      name: "Dragon's Gold",  icon: '🐉', cat: 'slots',     tag: 'to 210×' },
    { key: 'frost',       name: 'Frozen Peaks',   icon: '❄️', cat: 'slots',     tag: 'low variance' },
